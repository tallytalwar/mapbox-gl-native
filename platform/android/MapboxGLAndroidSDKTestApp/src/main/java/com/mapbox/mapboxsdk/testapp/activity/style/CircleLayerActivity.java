    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull final MapboxMap map) {
                mapboxMap = map;
                try {
                    mapboxMap.addSource(new GeoJsonSource("bus_stop", new URL("https://raw.githubusercontent.com/cheeaun/busrouter-sg/master/data/2/bus-stops.geojson")));
                ...
                fab.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        // add route as a line
                        try {
                            mapboxMap.addSource(new GeoJsonSource("bus_route", new URL("https://gist.githubusercontent.com/tobrun/7fbc0fe7e9ffea509f7608cda2601d5d/raw/a4b8cc289020f91fa2e1553524820054395e36f5/line.geojson")));
